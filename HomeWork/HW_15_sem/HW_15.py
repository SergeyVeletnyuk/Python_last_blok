...
#
# Разбейте задачу на отдельные операции — функции.Дополнительно сохраняйте все операции поступления и снятия средств
# в список
    ...
    while True:
        ...
        try:
            if action == "1":
                ...
                logging.info(f'Снятие {amount} у.е. (комиссия: {commission} у.е.)')
        ...
        if transaction_counter % 2 == 0:
            print(
                "\nПредупреждение! При следующей операции пополнения или снятия наличных начистится процент в пользу "
                "банка!!! ")
